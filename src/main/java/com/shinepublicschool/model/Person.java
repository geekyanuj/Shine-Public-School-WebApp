...
public class Person extends BaseEntity{
    ...
    @JoinColumn(name ="class_id", referencedColumnName = "classId", nullable = true) // we don't create cascade related config since it will never create class while creating person but vice versa is true
