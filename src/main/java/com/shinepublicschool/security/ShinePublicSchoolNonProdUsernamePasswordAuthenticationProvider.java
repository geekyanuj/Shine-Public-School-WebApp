...
@Component
@Profile("!prod")  // conditional creating bean for only non prod profile
public class ShinePublicSchoolNonProdUsernamePasswordAuthenticationProvider implements AuthenticationProvider {
